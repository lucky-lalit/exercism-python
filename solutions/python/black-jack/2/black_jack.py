...
def value_of_ace(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    # print('debug5',card_one,card_two)
    if value_of_card(card_one) + value_of_card(card_two) > 10:
        # if card == 'A':
        return 1
    elif value_of_card(card_one) == 1 or value_of_card(card_two) == 1:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    # print('debug1',value_of_ace(card_one,card_two))
    # print('debug2',value_of_card(card_one),card_one)
    # print('debug3',value_of_card(card_two),card_two)
    # print('debug4',value_of_ace(card_one,card_two))
